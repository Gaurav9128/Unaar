...
import "./Developments.css"; // Custom CSS for additional styling
  ...
  return (
    <div className="container py-5">
      <div className="d-flex justify-content-between align-items-center mb-4">
        ...
        New developments in Dubai <span className="text-muted">(679 Listings)</span>
        </h2>
      ...
      <div className="row">
        {developments.map((apt, index) => (
          <div key={index} className="col-md-6 col-lg-3 mb-4">
            <div className="card apartment-card">
              <img src={apt.image} className="card-img-top" alt="Developments" />
